...
\begin{abstract}
Simple, wearable devices are a promising way of encouraging participation with those who consume and contribute to transmedia. 

The research question that motivates this research is whether it is possible to augment in very simple ways using visual and vibrotactile patterns within transmedia games such that the gamer or device wearer is better able to understand and enjoy gameplay.

We describe a series of demo experiences focusing on the communication of information through low resolution vibrotactile and LED displays.

We explore techniques through use of simple visual and vibro-tactile patterning for children aged 8-12, which add sensory interest to gameplay as well as convey useful information about basic game dynamics and expected user interactions.
\end{abstract}
...
This project involves adding simple user involvement and user participation to complex transmedia games and their accompanying narratives.  

Transmedia games are one in which the viewer switches between various media types in a fluid and natural way in such a way that narratives become richer and involve more of the senses. Transmedia narratives are by their nature complex and multisensory \cite{phillips_creators_2012}. 
