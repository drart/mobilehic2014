...
The felt bands are quite wearable while the rubber bands are much less unwearable, even if their components were miniaturized. The felt approach lends itself to user comfort, while the rubber approach doesn't. Despite this, it is conceivable that each could find its stylistic audience. 

It is not clear that simple gameplay in the form, of say, \emph{Simon Says} type games would necessarily attract many users. Some additional functions such as decorative, visual or rhythmic display of interesting patterns might prove more appealing. As well, as non-intrusive notification devices they show promise.  
