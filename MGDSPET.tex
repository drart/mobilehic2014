...
The research question we address in this paper concerns whether it is possible to create wearable gaming experiences that involves simple visual and vibrotactile patterns. Some  research questions of interest to us are:
\begin{inparaenum}[\itshape a\upshape)]
\item what types of pattern for wearable devices are appropriate?
\item what is the best function for these patterns?
\item what kinds of haptic patterns can be created using a minimal number of actuators?
...
The next steps are simple 2D grids of LED lights, buttons and vibro-tactile actuators. 
\bigskip
\begin{figure}
  	\begin{center}
	\begin{tikzpicture}
...
The basic components used on our devices are buttons, LED lights and vibrating motors. These elements can be arranged in a variety of 1D, 2D, or 3D arrays. At its simplest, the user interaction involves pressing a button. 
