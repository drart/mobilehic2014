...
% ===========================================================================
Tactile feedback is often used in gaming to enhance immersive experiences. Vibrotactile arrays on wearable devices can enable a variety of information communication scenarios, the most compelling of which is when they enable users to receive information without having to look at a signifying device \cite{matscheko2010tactor,maclean2009putting}. There are many examples of projects that do this tethered to devices with screens. This project uses an wearable device that is able to offer self-sufficient gaming experiences that need not be tethered to other devices. The patterns are presented to the user using these wearable devices involve both visually and tactile stimului. 
